            ...
            <Paper sx={{width: "100%", padding: 10, position: "relative"}}>
                ...
                <form onSubmit={(e) => e.preventDefault()}>
                    ...
                    <FormControl fullWidth margin={"normal"}>
                        ...
                        <Box>
                            <Typography variant="h6" style={{textDecoration: 'underline'}}>Section A: Student Name
                                Change</Typography>
                            <Typography padding="10px">
                                The University of Houston record of your name was originally taken from your application
                                for admission and may be changed if:
                                <br/><br/>1. You have married, remarried, or divorced (a copy of marriage license or
                                portion of divorce decree indicating new name must be
                                provided)
                                <br/>2. You have changed your name by court order (a copy of the court order must be
                                provided)
                                <br/>3. Your legal name is listed incorrectly and satisfactory evidence exists for its
                                correction (driver license, state ID, birth certificate,
                                valid passport, etc., must be provided)
                                <br/><br/>NOTE: A request to omit a first or middle name or to reverse the order of the
                                first and middle names cannot be honored unless
                        ...
                        <Box paddingTop={3}>
                            ...
                            <Typography>
                                I request that my legal name be changed and reflected on University of Houston records
                                as listed below:
                            </Typography>
                        ...
                        <Box>
                            <Typography variant="h6" style={{textDecoration: 'underline'}}>Section B: Student Social
                                Security Number Change</Typography>
                            <Typography>
                                The University of Houston record of your Social Security Number was originally taken
                                from your application for admission and
                                may be changed only if the student has obtained a new social security number or an error
                                was made. In either case, the student
                    ...
                    submitted with a valid government-issued photo ID (such as a driver license, passport, or military ID).</span>
                        ...
                        <Box paddingTop={3}>
                            <Typography>
                                <div style={{textDecoration: 'underline', fontWeight: 'bold'}}>Please print and complete
                                    the following information:
                                </div>
                                I request that my Social Security Number be changed and reflected on
                        ...
                        <Typography paddingTop={3}>
                            I authorize the University of Houston Main Campus to make the updates/changes to my student
                            record as
                            requested above.
                        </Typography>
                        <Box
                        ...
                        <Typography sx={{fontSize: 13}}>
                            "State law requires that you be informed of the following: (1) with few exceptions, you are
                            entitled on request to be informed about the information the University collects about you
                            by use of this form; (2) under
                            sections 552.021 and 552.023 of the Government Code, you are entitled to receive and review
                            the information; and (3) under section 559.004 of the Government Code, you are entitled to
                            have the University correct

      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        ...
        >
          ...
          <div className="space-y-2 sm:col-span-12 lg:col-span-4">
            <div>
              <img src="/cube.png" alt="Logo" style={{height: "120px"}}/>
            </div>
